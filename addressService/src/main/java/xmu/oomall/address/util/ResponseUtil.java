...
public class ResponseUtil {
    ...
    public static Object invalid() {
        return fail( 754,"该地址是无效地址");
    }

    public static Object addFail() {return fail(751,"地址新增失败");}

    public static Object updateFail() {return fail(752,"地址修改失败");}

    public static Object deleteFail() {return fail(753,"地址删除失败");}
